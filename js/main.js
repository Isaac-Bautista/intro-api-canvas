...
function draw_arcTo() {
  const canvas = document.getElementById("canvas_arcTo");
  if (canvas.getContext) {
    const ctx = canvas.getContext("2d");
...
function draw_quadraticcurveTo() {
  const canvas = document.getElementById("canvas_quadraticcurveTo");
  if (canvas.getContext) {
    const ctx = canvas.getContext("2d");
...
function draw_beziercurveTo() {
  const canvas = document.getElementById("canvas_beziercurveTo");
  if (canvas.getContext) {
    const ctx = canvas.getContext("2d");
...
function draw_combinarfunciones() {
  const canvas = document.getElementById("canvas_combinarfunciones");
  if (canvas.getContext) {
    const ctx = canvas.getContext("2d");
...
draw_lineTo();
draw_arcTo();
draw_quadraticcurveTo();
draw_beziercurveTo();
draw_combinarfunciones();
draw_Path2D();